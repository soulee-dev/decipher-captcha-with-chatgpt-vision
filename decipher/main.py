...
def calculate_cosine_similarity(text_list1, text_list2):
  ...
  for i in range(len(text_list1)):
    similarity = cosine_similarity(tfidf_matrix[i], tfidf_matrix[len(text_list1) + i])
...
def main():
    ...
    similarities, average_similarity = calculate_cosine_similarity(answer_list[:50], response_answer_list)
